...
public class MessageDb extends AbstractDbRepository<Long, Message> {
    ...
    protected PreparedStatement addQuery(Message entity, Connection connection) throws SQLException {
        ...
        return connection.prepareStatement("insert into messages (userFrom , userTo ,dataM , mesaj,reply) values (" + entity.getUserFrom()+","+entity.getUserTo() + ",'" + Timestamp.valueOf(entity.getDate()).toString() + "' , '"+ entity.getMesaj()+"' ,"+entity.getReply() +")" );
